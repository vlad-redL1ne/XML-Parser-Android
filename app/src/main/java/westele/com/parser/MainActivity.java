...
public class MainActivity extends ActionBarActivity {
        ...
        /*lvPcsPost.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (postValueArrayList != null && postValueArrayList.size() > 0) {
                    //Intent intentShowPost = new Intent(this, TableActivity.class);
                    Intent intentShowPost = new Intent(Intent.ACTION_VIEW, Uri.parse(postValueArrayList.get(position).getImg()));
    ...
    class PostAsync extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            pd = ProgressDialog.show(MainActivity.this, "", "Loading posts...", true, false);
        }
